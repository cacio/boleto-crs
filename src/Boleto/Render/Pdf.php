...
class Pdf extends AbstractPdf implements PdfContract
{
    ...
    protected function instrucoes($i)
    {
        ...
        if ($this->showInstrucoes) {
            ...
            $this->SetFont($this->PadraoFont, '', $this->fcel);
            $this->Cell(25, $this->cell, $this->_('Número Doc.: '), 0, 0);
            $this->SetFont($this->PadraoFont, 'B', $this->fcel);
            $this->Cell(0, $this->cell, $this->_($this->boleto[$i]->getNumeroDocumento()), 0, 1);
            $this->SetFont($this->PadraoFont, '', $this->fcel);
            $this->Cell(25, $this->cell, $this->_('Valor: '), 0, 0);
            $this->SetFont($this->PadraoFont, 'B', $this->fcel);
            $this->Cell(0, $this->cell, $this->_(Util::nReal($this->boleto[$i]->getValor())), 0, 1);
            $this->SetFont($this->PadraoFont, '', $this->fcel);
			$this->Cell(25, $this->cell, $this->_('Pagador: '), 0, 0);
            $this->SetFont($this->PadraoFont, 'B', $this->fcel);
            $this->Cell(0, $this->cell, $this->_($this->boleto[$i]->getPagador()->getNomeDocumento()), 0, 1);
            $this->SetFont($this->PadraoFont, '', $this->fcel);
    ...
    protected function Topo($i)
    {
        ...
        $this->SetFont($this->PadraoFont, 'B', $this->fcel - 2);

        //$this->textFitCell(75, $this->cell, $this->_($this->boleto[$i]->getBeneficiario()->getNomeDocumento()).utf8_decode(" Endereço: ").$this->_($this->boleto[$i]->getBeneficiario()->getEndereco())." ".$this->_($this->boleto[$i]->getBeneficiario()->getCepCidadeUf()), 'LR', 0, 'L');
		$this->Cell(75, $this->cell - 3, $this->_($this->boleto[$i]->getBeneficiario()->getNomeDocumento()), 'LR');
		$this->Ln(0);
		$this->Cell(75, $this->cell +1,utf8_decode("Endereço: ").$this->_($this->boleto[$i]->getBeneficiario()->getEndereco())." ".$this->_($this->boleto[$i]->getBeneficiario()->getCepCidadeUf()), 'L');
		$this->SetFont($this->PadraoFont, 'B', $this->fcel);
		
        $this->Cell(35, $this->cell, $this->_($this->boleto[$i]->getAgenciaCodigoBeneficiario()), 'LR');
        ...
        $valor = $this->boleto[$i]->getDesconto() > 0 ? $this->boleto[$i]->getValor() + $this->boleto[$i]->getDesconto() : $this->boleto[$i]->getValor();
        $this->Cell(50, $this->cell, $this->_(Util::nReal($valor)), 'R', 1, 'R');
        ...
        $this->SetFont($this->PadraoFont, 'B', $this->fcel);
        $this->Cell(30, $this->cell, $this->_( $this->boleto[$i]->getDesconto() > 0 ? Util::nReal($this->boleto[$i]->getDesconto()) : '' ), 'LR');
        ...
        $this->SetFont($this->PadraoFont, 'B', $this->fcel);
		if($this->boleto[$i]->getCodigoBancoComDv() == '041-8'){
			$this->Cell(0, $this->cell, $this->_($this->boleto[$i]->getPagador()->getNomeDocumento()."."), 'LR', 1);	
			$this->Cell(0, $this->cell, $this->_("SAC BANRISUL 0800-646-1515, OUVIDORIA BANRISUL 0800-644-2200"), 'BLR', 1);
		}else if($this->boleto[$i]->getCodigoBancoComDv() == '104-0'){
			$this->Cell(0, $this->cell, $this->_($this->boleto[$i]->getPagador()->getNomeDocumento()), 'LR', 1);
			...
			$this->Cell(0, $this->cell, $this->_("SAC CAIXA: 0800 726 0101 (informações, reclamações, sugestões e elogios)."), 'LR', 1);
			$this->Cell(0, $this->cell, $this->_("Para pessoas com deficiência auditiva ou de fala: 0800 726 2492. Ouvidoria: 0800 725 7474. caixa.gov.br."), 'BLR', 1);			
    ...
    protected function Bottom($i)
    {
        ...
        $this->SetFont($this->PadraoFont, 'B', $this->fcel - 2);
        $this->Cell(120, $this->cell - 3, $this->_($this->boleto[$i]->getBeneficiario()->getNomeDocumento()), 'LR');
		$this->Ln(0);
		$this->Cell(120, $this->cell + 1,utf8_decode("Endereço: ").$this->_($this->boleto[$i]->getBeneficiario()->getEndereco())." ".$this->_($this->boleto[$i]->getBeneficiario()->getCepCidadeUf()), 'LR');
		//$this->Cell(0, $this->cell, utf8_decode(" Endereço: ").$this->_($this->boleto[$i]->getBeneficiario()->getEndereco())." ".$this->_($this->boleto[$i]->getBeneficiario()->getCepCidadeUf()), 'LR');
		$this->SetFont($this->PadraoFont, 'B', $this->fcel);
		...
		if($this->boleto[$i]->getCodigoBancoComDv() == '104-0'){
       ...
       // $this->Cell(50, $this->cell, $this->_(Util::nReal($this->boleto[$i]->getValor())), 'R', 1, 'R');
		...
		if($this->boleto[$i]->getCodigoBancoComDv() == '104-0'){
			$this->Cell(50, $this->desc, $this->_('(-) Outras Deduções/Abatimento'), 'TR', 1);
		}else{
