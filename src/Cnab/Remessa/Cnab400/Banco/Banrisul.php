...
class Banrisul extends AbstractRemessa implements RemessaContract
{
    ...
    public function addBoleto(BoletoContract $boleto)
    {
		...
		//echo $boleto->getMoraDia()."\n";
		if($boleto->getJuros() > 0){
			$this->add(161, 161, '1');
			$this->add(162, 173, Util::formatCnab('9',$boleto->getJuros(), 12, 2));//Util::formatCnab('9', $boleto->getMoraDia(), 12, 2)
			$this->add(174, 192, '');
		}else{
			$this->add(161, 161, '');
        ...
        $this->add(193, 205, '');//Util::formatCnab('9', '', 13, 2)
        $this->add(206, 218, '');//Util::formatCnab('9', '', 13, 2)
