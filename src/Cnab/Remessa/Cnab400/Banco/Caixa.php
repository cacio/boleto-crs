...
class Caixa  extends AbstractRemessa implements RemessaContract
{
    ...
    protected function header()
    {
        ...
        $this->add(31, 37, Util::formatCnab('9', substr($this->getCodigoCliente(), 0, 7), 7));
        $this->add(38, 46, '');
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        $this->boletos[] = $boleto;
        $this->iniciaDetalhe();
		//echo substr($this->getCodigoCliente(), 0, 7);
        $this->add(1, 1, '1');
        $this->add(2, 3, strlen(Util::onlyNumbers($this->getBeneficiario()->getDocumento())) == 14 ? '02' : '01');
        $this->add(4, 17, Util::formatCnab('9', Util::onlyNumbers($this->getBeneficiario()->getDocumento()), 14));
        $this->add(18, 20, '000');//Util::formatCnab('9', $this->getAgencia(), 3)
        $this->add(21, 27, Util::formatCnab('9', substr($this->getCodigoCliente(), 0, 7), 7));
