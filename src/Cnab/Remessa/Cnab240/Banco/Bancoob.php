...
class Bancoob extends AbstractRemessa implements RemessaContract
{
    ...
    protected function segmentoP(BoletoContract $boleto)
    {
        ...
        $this->add(36, 36, Util::formatCnab('X', $boleto->getContaDv(), 1));
        $this->add(37, 37, '');
        ...
        $this->add(106, 106, '');
        $this->add(107, 108, Util::formatCnab('9', 03, 2)); //$boleto->getEspecieDocCodigo()
        ...
        $this->add(119, 126, $boleto->getDataVencimento()->modify('+1 day')->format('dmY'));
    ...
    protected function header()
    {
        ...
        $this->add(71, 71, Util::formatCnab('9', $this->getContaDv() ?: 0, 1));
        $this->add(72, 72, '0');
    ...
    protected function headerLote()
    {
        ...
        $this->add(72, 72, Util::formatCnab('9', $this->getContaDv() ?: 0, 1));
        $this->add(73, 73, '');
