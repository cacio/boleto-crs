...
class Unicred extends AbstractRetorno implements RetornoCnab400
{
    ...
    protected function processarDetalhe(array $detalhe)
    {
        ...
        $d->setNossoNumero($this->rem(52, 62, $detalhe))
            ...
            ->setDataOcorrencia($this->rem(111, 117, $detalhe))
            ->setDataVencimento($this->rem(147, 152, $detalhe))
            ->setValor(Util::nFloat($this->rem(153, 165, $detalhe), 2, false) / 100)
            ->setValorTarifa(Util::nFloat($this->rem(182, 188, $detalhe), 2, false) / 100)			
            ...
            ->setValorMulta(Util::nFloat($this->rem(267, 279, $detalhe), 2, false) / 100)
        ...
        $stringErrors = sprintf('%010s', $this->rem(319, 326, $detalhe));
